...
points3, = plt.plot(times_no_PTFE[ranges_no_PTFE[0]:ranges_no_PTFE[1]], forces_no_PTFE[ranges_PTFE[0]:ranges_PTFE[1]],
                    'o',
                    color=(1,0,0,0.15),
                    markersize=2,
                    markeredgewidth=0.0,
...
leg = plt.legend(handles=[points1, points2, points3, points4, points5, points6, points7, points8], prop={'size': 5.5})
ax = plt.gca().add_artist(leg)
plt.legend(handles=[line1, line2, line3], bbox_to_anchor=(0.66, 1.003), prop={'size': 7})

plt.ylim([21.4, 25.3])
plt.savefig("/home/max/phd/fibre-measurements/figures/stretching/steel-wire-25N-full.pdf", bbox_inches='tight')
plt.show()
